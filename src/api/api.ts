...
export const PetApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.findPetsByStatus(
        status,
        options
      );
      return createRequestFunction(
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createUsersWithArrayInput(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createUsersWithArrayInput(
        user,
        options
      );
      return createRequestFunction(
